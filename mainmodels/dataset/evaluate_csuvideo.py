...
def evaluate_test_results(sign_name="ps", prob_limit=0.6, iou_limit=0.4):
    ...
    model_res_path = "/Volumes/projects/repos/RSI/CSUVOCFormat/data/CSUVIDEO" \
                     "/results/LDSSD_512x512_score/Main/comp4_det_test_plane.txt"
    expect_res_path = "/Volumes/projects/repos/RSI/CSUVOCFormat/data/CSUVIDEO" \
                      "/results/LDSSD_512x512_score/Main/comp4_det_std_plane.txt"
    # 开始组织模型的测试结果和GT结果
    model_res_dict = dict()
