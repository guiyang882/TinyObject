...
total_test_image_path = dir_prefix + "all_test.txt"
model_res_prefix = dir_prefix + "results/"
expect_res_prefix = dir_prefix + "std_results/"
...
detail_dict = dict()
for _, sign_idx in sign_idx_dict.items():
    sign_name = idx_sign_dict[sign_idx]
    ...
    for iou in np.linspace(0, 1, 9):
        for prob in np.linspace(0, 1, 9):
            ...
            if iou == 0.625 and prob == 0.75:
                print(sign_name, prob, iou, precision, recall)
