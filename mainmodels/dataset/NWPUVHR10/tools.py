...
def show_nwpu_vhr_annotation(img_names):
    img_dir = "/Volumes/projects/DataSets/NWPU-VHR-10/positive_image_set/"
    anno_dir = "/Volumes/projects/DataSets/NWPU-VHR-10/ground_truth/"
    for name in img_names:
        img_path = img_dir + name + ".jpg"
        image = cv2.imread(img_path)

        anno_path = anno_dir + name + ".txt"
